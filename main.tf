...
#Deploys code from the https://github.com/ninovvas/taskboard repo, providing the Web app id, the URL of the repo and the main branch name
# repo_url               = "https://github.com/ninovvas/taskboard"
...
resource "azurerm_mssql_firewall_rule" "firewallmssql" {
